...
export default function RegisterNewSolarPowerPlant() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      setError(
        "Por favor, preencha todos os campos obrigatórios (incluindo a data de instalação e o tipo de ligação).",
      );
      return;
    }
    ...
    const data = {
      ...
      limite_beneficiarios: Number(beneficiariesLimit || 1),
      exposicao_solar_diaria: Number(sunExposure || 0),
      data_instalacao: installationDate,
      data_ultima_manutencao: lastMaintenanceDate || installationDate,
    };
    ...
    <div className="space-y-6 animate-fade-in relative pb-10">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          Insira as informações técnicas e de localização da sua nova usina de
          energia solar.
        </p>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <div>
                ...
                <span className="text-[10px] text-slate-400 mt-1 block">
                  Digite 8 dígitos para preenchimento rápido
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mb-4">
              <div>
                ...
                >
                  ...
                  <option value="BIFASICA_2_CONDUTORES">
                    Bifásica - 2 condutores
                  </option>

                  <option value="BIFASICA_3_CONDUTORES">
