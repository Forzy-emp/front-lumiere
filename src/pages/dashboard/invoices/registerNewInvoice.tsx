...
import {
  CadastroContaEnergia,
  type ContaEnergia
} from '../../../components/CadastroContaEnergia';

import {BandeiraTipo, NaturezaFaturaItem, TipoFaturaItem, RegisterFatura, type CreateFaturaRequest, type FaturaItemRequest} from '../../../service/fatura';
...
export default function RegisterNewInvoice() {
  ...
  const handleSave = async (dados: ContaEnergia) => {
    try {
      ...
      const payload: CreateFaturaRequest = {
        usinaId: dados.idUsina,
