  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Saving this month */}
        <div className="bg-gradient-to-br from-white to-slate-50 border border-slate-200 rounded-2xl p-6 shadow-sm flex items-center gap-6 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-lumiere-primary/5 rounded-full blur-2xl pointer-events-none" />
          <div className="w-14 h-14 rounded-full bg-lumiere-primary/10 flex items-center justify-center text-lumiere-tertiary flex-shrink-0">
        ...
        <div className="bg-gradient-to-br from-white to-slate-50 border border-slate-200 rounded-2xl p-6 shadow-sm flex items-center gap-6 relative overflow-hidden">
          ...
          <div className="w-14 h-14 rounded-full bg-lumiere-secondary/10 flex items-center justify-center text-lumiere-secondary flex-shrink-0">
