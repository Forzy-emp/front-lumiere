  ...
  return (
    <div className="max-w-3xl space-y-8 animate-fade-in font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Avatar Sidebar card */}
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 sm:p-6 flex flex-col items-center justify-center text-center shadow-sm">
          ...
          <p className="break-all text-xs text-slate-500 dark:text-slate-400 mt-1">{email}</p>
        ...
        {/* Edit Form */}
        <div className="md:col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 sm:p-6 shadow-sm">
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="flex justify-end pt-4 border-t border-slate-100 dark:border-slate-800">
              <button
                type="submit"
                disabled={loading}
                className="w-full sm:w-auto justify-center flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-lumiere-primary to-lumiere-tertiary hover:opacity-95 text-sm font-bold text-white rounded-xl shadow-lg shadow-lumiere-primary/10 hover:scale-[1.01] active:scale-[0.99] transition-all disabled:opacity-50"
              >
                {loading ? (
