...
import { Bell, Globe, ToggleLeft, ToggleRight } from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 opacity-60 cursor-not-allowed">
              <div>
                <span className="text-sm font-bold text-slate-700 dark:text-slate-200 flex items-center gap-2">
                  Idioma do Console
                  <span className="text-[10px] bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-slate-300 px-2 py-0.5 rounded-full uppercase tracking-wider font-semibold">Em breve</span>
                </span>
              ...
              <select 
                ...
                className="bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-400 dark:text-slate-400 py-2 px-4 focus:outline-none cursor-not-allowed"
              >
